  ...
  const loadData = async () => {
    ...
    if (row) {
      setData({
        ...
        decision_category_history: Array.isArray(row.decision_category_history) ? row.decision_category_history : [],
        ...
        <div className="px-5 pb-5">
          {!unlocked ? (
            ...
            <div className="space-y-3">
              ...
              {/* Decision category history */}
              {data.decision_category_history.length > 0 && (
                <div
                  className="rounded-xl p-3.5"
                ...
                >
                  <div className="flex items-start gap-2.5">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs font-bold text-slate-800 mb-2">Decision Types Across Workspaces</p>
                      <div className="flex flex-wrap gap-1 items-center">
                        {data.decision_category_history.map((cat, i, arr) => (
                          <span
                            key={i}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] text-slate-400 leading-relaxed mt-0.5">Accumulating data across workspaces\u2026</p>
                </div>
              </div>
