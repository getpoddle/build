...
describe("planFromProductId", () => {
  // Active product IDs (matching stripe-config.ts)
  it("maps the pro product to pro plan with 1 seat", () => {
    expect(planFromProductId("prod_UXcbO4NuuJRE5A")).toEqual({ plan: "pro", seats: 1 });
  });
