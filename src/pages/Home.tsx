    ...
    <div className="min-h-screen" style={{ background: '#f8fafc' }}>
      <div className="px-4 sm:px-6 lg:px-6 py-8 lg:py-10">
        ...
        <div className="mb-8 lg:mb-10">
          <h1 className="text-2xl lg:text-3xl font-black text-slate-900 mb-1">Dashboard</h1>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8 lg:mb-10">
          {STATS.map(({ label, value, sub, icon: Icon, color, bg }) => (
            ...
            >
              ...
              <p className="text-2xl lg:text-3xl font-black text-slate-900 mb-0.5">{value}</p>
            ...
            >
              ...
              <div className="relative flex flex-col sm:flex-row sm:items-center gap-8">
                <div className="flex-1">
                  <div
                    className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full text-[11px] font-semibold mb-4"
                    style={{ background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.12)', color: '#93c5fd' }}
                  >
                    <Sparkles className="w-3 h-3" />
                    Decision Intelligence Platform
                  </div>
                  <h2 className="text-xl lg:text-2xl font-black text-white mb-3 leading-snug">
                    AI agents that challenge<br className="hidden lg:block" /> your best thinking.
                  </h2>
                ...
                <div className="flex flex-col gap-3 sm:flex-shrink-0">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-bold text-sm transition-all hover:-translate-y-0.5 whitespace-nowrap"
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm transition-all whitespace-nowrap"
