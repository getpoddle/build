...
-- The admin check and auth.users deletion are handled by the edge function.
-- This RPC only handles data cleanup across public tables.
...
BEGIN
  ...
  -- Profile (auth.users deletion handled by edge function)
