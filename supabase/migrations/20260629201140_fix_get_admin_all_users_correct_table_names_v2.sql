...
-- Fix get_admin_all_users: referenced tables user_moderation_status, user_reports,
-- and referral_uses do not exist. Correct names are user_account_status,
-- content_reports, and referral_signups.
