-- Fix ambiguous column references in consume_war_room_session.
-- The RETURNS TABLE clause creates output variables named session_count,
-- overage_count, etc. These shadow the table column names inside the
-- function body, causing "column reference is ambiguous" errors whenever
-- the RPC is called. Qualifying columns with a table alias fixes it.
