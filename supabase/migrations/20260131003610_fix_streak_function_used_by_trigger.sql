/*
  # Fix streak function to use correct field name

  1. Changes
    - Replace update_user_challenge_streak function (used by trigger) to use `last_participation_date` instead of `last_completion_date`
    - The trigger `trigger_update_user_challenge_streak` calls this function
