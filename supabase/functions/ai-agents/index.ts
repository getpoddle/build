...
import { COUNTRY_NAMES, DEFAULT_NAMES, getNamesForCountry, AGENT_ROLES, TOPIC_AGENT_WEIGHTS, type TopicDomain } from "../_shared/personas.ts";
...
async function callOpenAI(systemPrompt: string, userMessage: string, maxTokens = 400, jsonMode = false, distinctId = "system", temperature = 0.6): Promise<string> {
  ...
  if (jsonMode && body.model !== "gpt-5.6-luna") {
